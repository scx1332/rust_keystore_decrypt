...
pub fn decrypt_key(keystore_str: &str, password: &str) -> Result<Vec<u8>, KeystoreError>
{
    ...
    let keystore_no_password = r#"
{
  ...
  "address": "fe51dd55acd72e84bdfa907f8fe44252e0457206"
    ...
    assert_eq!(secret, "c057eac4ce42c1ec20e918353ccb450de9306cbdd530eb74613e207836043250")
}
    ...
    let keystore_no_password = r#"
{
  ...
  "address": "5afa3ec4d616b059e9f0abd77e0a336e80dfb77e"
    ...
    assert_eq!(secret, "78bf400e180af932fe6cf071eef0176fddc94cd19ad0b2937f85506b143cd36a");
}